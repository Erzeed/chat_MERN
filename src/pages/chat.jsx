...
function Chat () {
    return(
        <div className="container_chat w-full flex h-screen bg-[#2e333d]">
            <div className="chat_log w-1/3 mt-5 border-sky-500 overflow-y-scroll">
                <div className="log_search p-2">
                    ...
                    <div className="relative">
                        ...
                        <input type="search" id="default-search" className="block w-full p-3 ps-10 text-sm text-gray-900 rounded-lg bg-gray-50 dark:bg-gray-700 focus:outline-none dark:text-white" placeholder="Search" required />
                    </div>
                </div>
            ...
            <div className="chat_profile w-1/4 bg-black">
